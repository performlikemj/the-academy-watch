...
BLOCKERS=[
 ...
 ("Nobody is using it and nothing pulls them in.","9 accounts (5 are the team), 1 claim, 0 clubs, 0 intros, 0 revenue. Newsletters stopped 2026-04-21. No sitemap or per-player share tags (SPA shell at every route), digests need an admin POST per send.","5.8, 5.3, 3.4"),
 ("'Fans' do not exist as a concept.","Only comments and a scout-branded watchlist star on tracked-player pages; local player pages have neither; no public follow, counts, or share card.","1.7"),
]
STAGES=[
