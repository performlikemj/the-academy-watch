...
def _nominatim_geocode(city: str, country: str | None = None) -> tuple[float, float] | None:
...
def get_team_coordinates(venue_city: str | None, venue_country: str | None = None) -> tuple[float, float] | None:
