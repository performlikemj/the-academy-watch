...
def _http() -> requests.Session:
    ...
    user_agent = os.getenv("WIKIPEDIA_USER_AGENT", "AcademyWatchBot/1.0 (+https://theacademywatch.com)")
...
def search_wikipedia_title(query: str, *, context: str = "") -> str | None:
...
def collect_player_loans_from_wikipedia(
    ...
    *,
    ...
    on_error: Callable[[dict[str, object], Exception], None] | None = None,
) -> list[dict[str, object]]:
            ...
            try:
                ...
                for res in search_results:
                    ...
                    data = classify_loan_row(
                        snippet, default_player=player_name, default_parent=parent_club, season_year=season_year
                    )
