...
def upgrade():
    if not table_exists("academy_leagues"):
        op.create_table(
            "academy_leagues",
    ...
    if not table_exists("academy_appearances"):
        op.create_table(
            "academy_appearances",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    create_index_safe("ix_academy_appearances_player", "academy_appearances", ["player_id"])
    create_index_safe("ix_academy_appearances_fixture_date", "academy_appearances", ["fixture_date"])
    create_index_safe("ix_academy_appearances_loaned_player", "academy_appearances", ["loaned_player_id"])
