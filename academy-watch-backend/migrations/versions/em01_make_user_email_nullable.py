...
def upgrade():
    ...
    op.alter_column("user_accounts", "email", existing_type=sa.String(255), nullable=True)
...
def downgrade():
    ...
    op.alter_column("user_accounts", "email", existing_type=sa.String(255), nullable=False)
