...
def upgrade():
    ...
    op.create_unique_constraint(
        "uq_digest_queue_user_newsletter", "newsletter_digest_queue", ["user_id", "newsletter_id"]
    )

    # Create index for efficient querying of unsent items by week
    op.create_index("ix_digest_queue_week_sent", "newsletter_digest_queue", ["week_key", "sent"])
