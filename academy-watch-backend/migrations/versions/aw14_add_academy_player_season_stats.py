...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("tracked_player_id", sa.Integer(), sa.ForeignKey("tracked_players.id"), nullable=True),
        sa.Column("updated_at", sa.DateTime()),
        sa.UniqueConstraint("player_api_id", "league_api_id", "season", name="uq_academy_player_season_stats"),
    )
