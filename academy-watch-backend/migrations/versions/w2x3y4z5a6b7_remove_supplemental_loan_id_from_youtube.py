...
def upgrade():
    ...
    try:
        op.drop_constraint(
            "newsletter_player_youtube_links_supplemental_loan_id_fkey",
...
def downgrade():
    ...
    # Recreate indexes
    op.create_index(
        "ix_newsletter_youtube_supplemental_id", "newsletter_player_youtube_links", ["supplemental_loan_id"]
    )

    op.create_index(
        "ix_newsletter_youtube_unique_supplemental",
        "newsletter_player_youtube_links",
