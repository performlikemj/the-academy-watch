...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('fixtures_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.UniqueConstraint(
            "fixture_id_api",
            name="fixtures_fixture_id_api_key",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('weekly_loan_reports_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["loaned_player_id"], ["loaned_players.id"], name=op.f("weekly_loan_appearances_loaned_player_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["weekly_report_id"], ["weekly_loan_reports.id"], name=op.f("weekly_loan_appearances_weekly_report_id_fkey")
        ),
        ...
        sa.UniqueConstraint(
            ...
            "loaned_player_id",
            "fixture_id",
            name=op.f("uq_week_player_fixture"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
