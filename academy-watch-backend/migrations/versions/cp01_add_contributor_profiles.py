...
def upgrade():
    ...
    op.create_index(
        op.f("ix_contributor_profiles_created_by_id"), "contributor_profiles", ["created_by_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_newsletter_commentary_contributor_id"), "newsletter_commentary", ["contributor_id"], unique=False
    )
