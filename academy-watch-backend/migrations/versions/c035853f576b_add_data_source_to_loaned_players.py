...
def upgrade():
    op.add_column(
        "loaned_players", sa.Column("data_source", sa.String(length=50), nullable=False, server_default="api-football")
    )
    op.add_column(
        "loaned_players", sa.Column("can_fetch_stats", sa.Boolean(), nullable=False, server_default=sa.true())
    )
