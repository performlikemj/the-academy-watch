...
def test_use_events_when_lineup_missing_stats():
    ...
    mock_events_response = {"response": [{"type": "Goal", "player": {"id": 67890}, "assist": {"id": 12345}}]}
...
def test_cards_added_from_events_when_lineup_missing():
    ...
    mock_events_response = {"response": [{"type": "Card", "detail": "Yellow Card", "player": {"id": 12345}}]}
...
def test_get_player_season_context_overlays_api_appearances(app, monkeypatch):
    ...
    fixture = Fixture(
        fixture_id_api=222,
        date_utc=datetime(2025, 9, 1, 17, 30, tzinfo=UTC),
        season=2025,
