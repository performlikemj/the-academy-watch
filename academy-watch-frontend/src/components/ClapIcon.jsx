...
// Simple clapping hands icon sourced from the Material Design Icons set (Apache-2.0).
// Uses currentColor so it inherits text color and can be scaled via className.
export function ClapIcon({ className, ...props }) {
  return (
    <svg
      viewBox="0 0 24 24"
      role="img"
