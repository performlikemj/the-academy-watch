    ...
    <LegalPageLayout title="Terms of Service" effectiveDate={EFFECTIVE_DATE}>
      ...
      {BILLING_TERMS_ENABLED ? (
        <section>
          ...
          <p>Some features — currently the Academy Watch chat assistant — use prepaid credits. New accounts receive a small free allowance. Credit packs are one-time purchases processed by Stripe; they do not renew and you will not be charged again unless you buy another pack. One credit is used per question. If an error on our side stops an answer, or your connection drops before the answer has begun, the credit is returned automatically. Once an answer has begun, the credit is used even if you stop or disconnect. Credits have no cash value and cannot be transferred. Unused packs can be refunded within 14 days of purchase by emailing <a href="mailto:mj@bywayofmj.com">mj@bywayofmj.com</a>; refunded credits are removed from your balance. Deleting your account forfeits any remaining credits. Pack prices are shown before you buy; later price changes do not affect credits you already hold.</p>
        </section>
      ) : null}
    </LegalPageLayout>
  )
