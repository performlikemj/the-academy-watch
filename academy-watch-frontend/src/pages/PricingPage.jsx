...
const TIERS = [
  {
    ...
    features: [
      ...
      '4-player comparison',
      'Custom scouting lists & CSV export',
      'Weekly newsletters',
    ],
  },
  {
    ...
    description: 'Ask deeper questions across academy pathways with our own AI scouting assistant.',
    features: [
      'Everything in The Stand',
      'GOL chatbot for academy research',
      'PDF exports of your GOL conversations',
    ],
  },
  {
    key: 'film',
