...
### Now
- **2026-09-06 iOS player/club experience implemented:** role-oriented Home, persistent My Profiles, unified identity search, adult-age validation, moderated basic-profile/photo/highlight editing, public-profile sharing, native club invitations and private feedback acknowledgment, and club-console handoff. 197 iOS unit/API tests, 5 offline UI journeys, 61 showcase + 24 trust tests, and unsigned archive pass. Local commit `3723bff8` on `feat/ios-player-club-experience`; user explicitly authorized pushing this branch to performlikemj/the-academy-watch and opening a draft PR; publication in progress. Deploy additive PATCH before binary release and update photo disclosure. See `ledgers/CONTINUITY_ios-player-club-experience.md`.
...
```
CONTINUITY.md
  └─ ledgers/CONTINUITY_ios-player-club-experience.md (complete locally; publication authorized; @owner:/root)
