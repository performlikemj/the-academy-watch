...
### Now
- **2026-09-06 iOS player/club experience implemented:** role-oriented Home, persistent My Profiles, unified identity search, adult-age validation, moderated basic-profile/photo/highlight editing, public-profile sharing, native club invitations and private feedback acknowledgment, and club-console handoff. 197 iOS unit/API tests, 5 offline UI journeys, 61 showcase + 24 trust tests, and unsigned archive pass. Branch `feat/ios-player-club-experience`; deploy additive PATCH before binary release and update photo disclosure. See `ledgers/CONTINUITY_ios-player-club-experience.md`.
...
```
CONTINUITY.md
  └─ ledgers/CONTINUITY_ios-player-club-experience.md (implemented and validated; draft PR next; @owner:/root)
