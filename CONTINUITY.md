...
- 2026-09-04: Billing dark-route regression now registers the real scout blueprint before billing; all 63 billing tests pass and the focused file passes Ruff check/format.
