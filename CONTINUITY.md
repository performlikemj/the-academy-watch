...
- [2026-09-06] Billing go-live: changed LegalPages effective date and billing E2E assertion from 2026-09-15 to 2026-09-06. Old-date search in src/ and e2e/: no matches. Frontend setup OSV: no issues; pnpm lint: pass (0 errors, 176 warnings); pnpm build: pass (chunk-size warning). Branch chore/billing-terms-date; PR targets main; do not merge.
