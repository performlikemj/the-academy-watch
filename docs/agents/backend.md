...
cross-field rules, and retain a counted coercion safety net. The first instance is the grounded
Qwen3-VL calls in `spike/video-analysis/qwen_match_analysis.py` (PR #972).
