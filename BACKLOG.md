...
| P0-D3 | `briefs/P0-D3.md` | Footage SAS ≤ token remaining life; sweeper keeps blob rows when storage unconfigured; preflight not swept (codex on PR #890). 3 step scripts + 3 shipped files. | in-progress |
