...
| P0-D5 | `briefs/P0-D5.md` | Abandoned created uploads swept by age; /process + /requeue FOR UPDATE; reaper CAS with RETURNING (codex round 3 on PR #890). 2 step scripts + 2 shipped files. | in-progress |
