...
| P0-D4 | `briefs/P0-D4.md` | Reaped jobs move their match processing→failed; sweeper re-checks under lock before delete (codex round 2 on PR #890). 1 step script + 3 shipped files. | in-progress |
