...
| P0-D9 | `briefs/P0-D9.md` | upload-complete keeps the original deadline; refuses a closed retention window (codex round 7 on PR #890). 2 step scripts + 2 shipped files. | done (a8a9512) |
