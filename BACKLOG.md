...
| P0-D8 | `briefs/P0-D8.md` | Completion fenced end-to-end; re-mint SAS refuses grants that would outlive the deadline; sweep waits a grant-lifetime (codex round 6 on PR #890). 2 step scripts + 3 shipped files. | in-progress |
