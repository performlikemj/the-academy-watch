...
| P0-D7 | `briefs/P0-D7.md` | Reaper + worker failure path move queued matches too, only while no other job is live; fail_running_job CAS (codex round 5 on PR #890). 1 step script + 3 shipped files. | in-progress |
